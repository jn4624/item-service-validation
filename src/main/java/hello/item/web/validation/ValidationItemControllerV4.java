...
import hello.item.web.validation.form.ItemUpdateForm;
...
public class ValidationItemControllerV4 {
    ...
    public String edit(@PathVariable Long itemId, @Validated @ModelAttribute("item") ItemUpdateForm itemUpdateFrom, BindingResult bindingResult) {
        // 특정 필드 예외가 아닌 전체 예외
        if (itemUpdateFrom.getPrice() != null && itemUpdateFrom.getQuantity() != null) {
            int resultPrice = itemUpdateFrom.getPrice() * itemUpdateFrom.getQuantity();
        ...
        Item item = new Item();
        item.setItemName(itemUpdateFrom.getItemName());
        item.setPrice(itemUpdateFrom.getPrice());
        item.setQuantity(itemUpdateFrom.getQuantity());
